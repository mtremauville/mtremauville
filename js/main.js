...
const i18n = {
  fr: {
    ...
    'about.p3':           "Je peux <strong>coder un POC le matin et le démo à un CTO l'après-midi</strong>.",
    'stat.label1':        'ans de tech client',
    'stat.label2':        'projets IA dont 2 en prod',
  ...
  en: {
    ...
    'about.p3':           "I can <strong>code a POC in the morning and demo it to a CTO in the afternoon</strong>.",
    'stat.label1':        'years in tech sales',
    'stat.label2':        'AI projects  2 shipped',
    'stat.label3':        'Le Wagon AI',
